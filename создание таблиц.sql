...
--таблица профиля сотрудников. таблица заполняется где то в отделе кадров, после изменений данных сотрудника в этой
таблице, данные будут меняться в таблице employee, для историчности
...
------------------------------------------------------------------------------------------------------------------------
--таблица позиций, позиции на которых сотрудник работает(специалист, старший специалист и.т.) тут записи можно добавлять
и редактировать
...
------------------------------------------------------------------------------------------------------------------------
--таблица типа активности сотрудника
...
------------------------------------------------------------------------------------------------------------------------
--таблица результата активности сотрудника
...
------------------------------------------------------------------------------------------------------------------------
 ...
 ---таблица клиенты в работе заполняется автоматически при добавлении нового клиента, попадает в работу сотруднику,
при совпадении региона проживания клиента и региона работы сотрудника
